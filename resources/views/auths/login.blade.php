			...
			<div class="vertical-align-middle">
				<div class="auth-box ">
					<div class="left">
						<div class="content">
							<div class="header">
								<div class="logo text-center"><img src="{{ url('') }}/assets/img/logo-dark.png" alt="Klorofil Logo"></div>
					...
					<div class="right">
						...
						<div class="content text">
							<h1 class="heading">Aplikasi Pengelolaan Data Beasiswa</h1>
							<p>by Yuga Kurniawan</p>
						</div>
					</div>
